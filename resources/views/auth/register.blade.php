                                ...
                                <div class="form-group">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="password" id="password_confirmation" name="password_confirmation"
                                            class="form-control pl-15 bg-transparent text-white plc-white @error('password_confirmation') is-invalid @enderror"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="checkbox text-white">
                                            <input type="checkbox" id="basic_checkbox_2" required>
                                            <label for="basic_checkbox_2">I agree to the <a href="#"
                                                    class="text-warning"><b>Terms</b></a></label>
                                        </div>
                                    </div>
                                    <!-- /.col -->
                                    <div class="col-12 text-center">
                                        <button type="submit" class="btn btn-info btn-rounded margin-top-10">SIGN
                                            UP</button>
                                    </div>
                                    <!-- /.col -->
                                </div>
